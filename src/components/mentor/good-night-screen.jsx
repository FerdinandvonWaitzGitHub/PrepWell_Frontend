    ...
    <div className="h-screen bg-white flex flex-col overflow-hidden">
      ...
      <div className="flex-1 px-12 flex flex-col justify-center items-center gap-10">
        <div className="max-w-[1058px] w-full flex justify-center items-center">
          <h1 className="text-center text-gray-900 text-4xl lg:text-5xl font-extralight leading-tight">
            Gute Nacht, {userName}.
          </h1>
        </div>
        ...
        <div className="flex flex-col gap-4 items-center">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-3xl border border-gray-200 flex items-center gap-2 hover:bg-gray-50 transition-colors"
          >
