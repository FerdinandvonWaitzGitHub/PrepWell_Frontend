      ...
      <div className="text-center max-w-md px-8">
        ...
        <div className="mt-8 space-y-3">
          <div className="flex items-center gap-3 text-left">
            ...
            <span className="text-sm text-neutral-600">Einstellungen übernommen</span>
          </div>
          <div className="flex items-center gap-3 text-left">
            <div className="w-5 h-5 rounded-full bg-green-500 flex items-center justify-center">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="3">
            ...
            <span className="text-sm text-neutral-600">Struktur erstellt</span>
          </div>
          <div className="flex items-center gap-3 text-left">
            <div className="w-5 h-5 rounded-full border-2 border-primary-500 flex items-center justify-center">
              <div className="w-2 h-2 bg-primary-500 rounded-full animate-pulse" />
            </div>
            <span className="text-sm text-neutral-900 font-medium">Kalender wird befüllt...</span>
          </div>
        </div>
      </div>
    </div>
