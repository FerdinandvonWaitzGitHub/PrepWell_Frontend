  ...
  return (
    <div className="px-4 md:px-36 flex flex-col items-center gap-5 mb-8">
      ...
      <div className="w-full py-[5px] flex justify-center items-center">
        <h1 className="text-center text-3xl md:text-5xl font-extralight text-gray-900 leading-tight md:leading-[48px]">
          {title}
        </h1>
      </div>
      ...
      {/* Description */}
      {description && (
        <p className="w-full max-w-[900px] text-center text-sm font-light text-gray-500 leading-5">
          {description}
        </p>
      )}
    </div>
